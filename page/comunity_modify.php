...
<div class="wrapper">
	<form method = "POST" action = "/comunity_modify_action">
			...
			<tr>
				<td bgcolor=white>
					<table class = "table2" style="width:100%">
						...
						<tr>
							<td>제목</td>
							<td><input type=text name=title size=60 value="<?=$data['title']?>"></td>
						</tr>
						<tr>
							<td>내용</td>
							<td><textarea name=content cols=85 rows=15><?=$data['cont']?></textarea></td>
						</tr>
					</table>
					<center>
